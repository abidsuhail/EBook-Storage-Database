...
public abstract class BooksDatabase extends RoomDatabase {
    ...
    public static synchronized BooksDatabase getInstance(Context context)
    {
        if (instance==null)
        {
            instance= Room.databaseBuilder(context.getApplicationContext(),BooksDatabase.class,"BooksDB")
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            ...
            executors.execute(new Runnable() {
                ...
                public void run() {
                    ...
                    initInsertData(bookDAO,categoryDAO);
                }
            });
    ...
    private static void initInsertData(BookDAO bookDAO, CategoryDAO categoryDAO) {
